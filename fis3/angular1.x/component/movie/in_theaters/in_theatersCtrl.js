angular.module('myApp.in_theatersCtrlModule',[])

	.controller('in_theatersCtrl',['$scope','$location','$routeParams','myService',function($scope,$location,$routeParams,myService){
